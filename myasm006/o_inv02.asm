dcompr equ $0020    ;wakaru
wrtvrm equ $004d    ;bios n yatu
ldivrm equ $005c
chgmod equ $005f
chput equ $00a2
breakx equ $00b7
...
org $4000           ;wakaru rom kokokara

Header:
    defb 'A', 'B', $10, $40, $00, $00, $00, $00 ;wakaru
    defb $00, $00, $00, $00, $00, $00, $00, $00 ;rom hituyou

; 変数の初期化
call setInitialData     ;sensei n hensuu

init: 

ld a,15                 ;wakaru gamen n iro
ld (forclr),a
ld a,1
ld (bakclr),a
ld (bdrclr),a
call chgmod
call chrset             ;wakaru chr sakusei
ld a,$c0
ld (canon),a            ;wakaru canon c0
ld a,0
ld (joystk),a
call invini
ld a,7
ld (timec1),a           ;wakaru time1 7
ld ix,canon
call getxy              ;wakaru get
ld a,(ix+0)             ;ayahuya ?
call wrtvrm
call dspinv

main:
call movcan             ;wakaru canon ido
call snstrg
call mvmisl
call invmov
call hitchk
...
ld a,(canon)
cp 0
jr z,init               ;canon 0 init
call breakx             ;bios? siraberu
ret c
jr main                 ;wakaru main loop modori
